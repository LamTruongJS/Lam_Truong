<header id="header" class="module bg-[#202c40] w-full top-0 left-0 fixed z-200 down_lg:overflow-hidden">
    <div class="container">
        <nav class="row navbar items-center">
            <div
                ...
                <div  class="lg:w-full relative">
                    <a id="header-logo" class="navbar-brand header-logo py-5 inline-block align-middle"
                        ...
                        <img src="<?= \App\asset_path('images/logo1.svg'); ?>" alt="<?php echo App::getLogo()['alt']; ?>" class="w-full">
                    </a>
                </div>
            ...
            <div class="col w-full lg:w-4/5 navbar-collapse main-menu flex flex-col justify-between" id="main-menu"
                data-module="menu">
                <ul
                    class="main-menu-ul navbar-nav list-none flex mb-0 p-0 flex-col text-inherit
        lg:flex-row lg:justify-end">
                    <li class="menu-item mb-0">
                        <a class="block py-9 lg:p-9 btn-white no-underline" href="#">ABOUT US</a>
                    </li>
                    <li class="menu-item mb-0">
