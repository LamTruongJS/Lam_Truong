<head>
    ...
    <!-- <?php echo e(App::getFavicon()); ?>  -->
    <link rel="apple-touch-icon" sizes="180x180" href="#">
    <!-- <?php echo e(App::getAppleIcon()); ?> -->
    ...
    <meta
      ...
      content="description of website"
    /> -->
    <meta property="og:image" content="<?= \App\asset_path('images/social_share.PNG'); ?>" />
    ...
    <meta
      ...
      content="description of website"
    /> -->
    <meta property="twitter:image" content="<?= \App\asset_path('images/social_share.PNG'); ?>" />
